...
include(":movecraft-v1_21_11")
include(":movecraft-v26_1_2")
...
project(":movecraft-v1_21_11").projectDir = file("v1_21_11")
project(":movecraft-v26_1_2").projectDir = file("v26_1_2")
